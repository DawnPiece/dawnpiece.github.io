...
The DawnPiece Server has many points of interest that have different functions. These POI's contain important merchants or essential NPC's to help you on your journey. POI's will be listed on the Point's of Interest section for each island in the [Island Guide](/Islands/Overview). General houses and locations related to [Discoveries](/General/Discoveries) are not included here.
...
- 🚨 [Jails](Jail.md) - Information related to jails and server rules.
