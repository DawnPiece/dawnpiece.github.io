...
Please see the sections below regarding the information you need to know for the Revolutionary Life Path. The in game suffix color for this life path is Dark Red.

## Ranks

| Rank Name     			| Rank Type     |
|-----------    			|-----------    |
| Revolutionary Recruit 	| Starting      |
| Revolutionary Member   	| 50,000,000    |
| Revolutionary Officer  	| 200,000,000   |
| Revolutionary Captain  	| 500,000,000   |
| Revolutionary Commander   | 1,000,000,000 |
| Chief of Staff    		| 2,000,000,000 |   
| Most Wanted       		| 4,000,000,000 |
...
Note: All Trials Bosses also have a chance to drop Legendary Orbs, Boss Souls and Awakening Fragments. Insignias are used to unlock the [Black Market](/Islands/BlackMarket) so make sure to store it safely since you only get one.
