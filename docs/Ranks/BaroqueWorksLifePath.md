...
Please see the sections below regarding the information you need to know for the Baroque Works Life Path. The in game suffix color for this life path is Purple.

## General Ranks

| Rank Name             | Rank Type     |
|-----------            |-----------    |
| Baroque Works Recruit | Starting      |
| Millions              | 50,000,000    |
| Billions              | 200,000,000   |
| Frontier Agent        | 500,000,000   |
| Unluckies             | 1,000,000,000 |
| Officer Agent         | 2,000,000,000 |   
| Mr. 0                 | 4,000,000,000 |
